...
const Settings = () => {
    ...
    const handleDeleteAllCategories = async () => {
        const confirmed = window.confirm('Are you sure you want to delete all custom categories? This action cannot be undone.');
        if (confirmed) {
            try {
    ...
    return (
        <div>
            ...
            <div id="main-content">
                ...
                <p>Selected Category: <span id="selected-category">{selectedCategory}</span></p>
                <div id="action-buttons">
                    <button id="delete-all-categories-btn" className="danger-btn" onClick={handleDeleteAllCategories}>
                        Delete All Categories
                    </button>
                    <button id="delete-all-todos-btn" className="danger-btn" onClick={handleDeleteAllTodos}>
                        Delete All Todos
                    </button>
                ...
                <div id="custom-category-container">
                    ...
                    />
                    <button type="button" id="add-custom-category-btn" onClick={handleAddCustomCategory}>
                        Add Category
                    </button>
                </div>
            </div>
